...
export default function Stats({
  ...
  return (
    <div>
      <h3 className="text-xl leading-6 font-medium text-secondary">
      ...
      <div className="mt-5 grid grid-cols-1 rounded-lg bg-white overflow-hidden shadow md:grid-cols-4">
        <div>
          <div className="px-4 py-5 sm:p-6">
            <dl>
              <dt className="text-base leading-6 font-normal text-secondary">
                Cumulative Layout Shift (CLS)
              </dt>
              <dd className="mt-1 flex justify-between items-baseline md:block lg:flex">
                {cls === -1 ? (
                  <div className="flex items-baseline text-2xl leading-8 font-semibold text-secondary-3 skeleton-box">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <span className="ml-2 text-sm leading-5 font-medium text-gray-500"></span>
                  </div>
                ) : (
                  <div className="flex items-baseline text-2xl leading-8 font-semibold text-secondary-3">
                    {cls}
                    <span className="ml-2 text-sm leading-5 font-medium text-gray-500"></span>
                  </div>
                )}
